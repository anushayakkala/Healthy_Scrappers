package com.reference;
	...
	public class HyperTension extends BaseTest {
		...
		public static void highBloodPressure() throws InterruptedException, IOException {
			...
			for (int p = 1; p <= 3; p++) {
...

				{
					...
					boolean isIngrediantAdds=AddOnList.checkAddOns(Ingrediants);
			...
			xlreader.setcelldata("Sheet1", 0,8,"Targetted morbid conditions (Diabeties/Hypertension/Hypothyroidism)");
